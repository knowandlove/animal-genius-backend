-- Fix currency transaction type to match constraint
-- The constraint expects 'quiz_reward' for positive amounts, not 'quiz_complete' or 'earn'
...
BEGIN
  ...
  -- 8. Log currency transaction with CORRECT type for constraint
