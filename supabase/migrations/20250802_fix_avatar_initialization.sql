-- Fix avatar data initialization to include colors structure
-- This ensures FirstTimeAvatarCustomization shows on first room visit

-- Update the create_student_from_quiz_with_results function to initialize avatar_data
...
-- Update any existing students who don't have avatar_data initialized
UPDATE public.students
SET avatar_data = jsonb_build_object(
  'colors', jsonb_build_object(
    'hasCustomized', false,
    'primaryColor', null,
    'secondaryColor', null
...
-- Add comment to clarify the expected structure
