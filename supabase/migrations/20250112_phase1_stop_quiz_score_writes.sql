-- Phase 1: Stop writing to quiz_score column
-- This updates the submit_quiz_atomic function to not write to quiz_score
...
BEGIN
  ...
  -- Create student record WITHOUT quiz_score since this is a personality quiz
  INSERT INTO students (
    ...
    user_id,
    school_year,
    -- REMOVED: quiz_score column reference
    created_at,
    updated_at
  ) VALUES (
    ...
    v_anon_user_id,
    grade,
    -- REMOVED: NULL value for quiz_score
    now(),
    now()
