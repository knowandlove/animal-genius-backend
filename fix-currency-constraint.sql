-- Fix currency transaction constraint issue
-- The constraint expects specific transaction types, but our function might be using 'earn'

-- Update the create_student_from_quiz function to use the correct transaction type
...
BEGIN
  ...
  -- 8. Log currency transaction with CORRECT transaction type
  INSERT INTO public.currency_transactions (
    ...
    v_student_id,
    v_starting_balance,
    'quiz_reward', -- CHANGED: Use 'quiz_reward' instead of 'quiz_complete' or 'earn'
