...
const { students, studentInventory, storeItems, patterns, itemTypes } = require('../shared/schema');
...
if (!passportCode) {
  console.log('Usage: node scripts/debug-pattern-ownership.js PASSPORT_CODE');
  console.log('Example: node scripts/debug-pattern-ownership.js PAN-2BQ');
  process.exit(1);
}
