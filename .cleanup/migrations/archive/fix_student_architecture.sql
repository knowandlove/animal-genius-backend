...
-- Step 5: Fix foreign key relationships to point to students table instead of quiz_submissions
...
CREATE INDEX IF NOT EXISTS idx_purchase_requests_student_id_new ON purchase_requests(student_id);
