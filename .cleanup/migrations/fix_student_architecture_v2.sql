...
-- Step 5: Drop and recreate the student_id columns with correct type
ALTER TABLE currency_transactions DROP COLUMN IF EXISTS student_id;
ALTER TABLE currency_transactions ADD COLUMN student_id TEXT NOT NULL;
...
ALTER TABLE purchase_requests ADD COLUMN student_id TEXT NOT NULL;
